        ...
        <div class="max-w-xl mx-auto bg-white rounded-xl shadow-md p-6 space-y-6">
            ...
            <form action="{{ route('obat.update', $obat->id) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $obat->nama) }}"
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga', $obat->harga) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm
                               focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm
                               focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        placeholder="Masukkan keterangan (opsional)">{{ old('keterangan', $obat->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
